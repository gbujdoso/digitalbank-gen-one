...
public class SearchService {
    ...
    public List<AtmLocation> searchATMLocations(String zipcode) throws Exception {
        ...
        try {
            ...
            InputStream inputStream = classLoader.getResourceAsStream("mock-responses/atm-locations.json");
            String mockJsonOutput = new String(inputStream.readAllBytes());

            // Mock ResponseEntity létrehozása
            ResponseEntity<String> responseEntity = ResponseEntity.ok(mockJsonOutput);

			/* MF - Géza - ATM search mocking
